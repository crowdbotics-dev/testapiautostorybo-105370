...
## Project Structure
    ...
    ├── testapiautostorybo_105370  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_105370`
...
2. Clone this repo and `cd testapiautostorybo_105370`
